...
snarkjs plonk setup HelloWorld/HelloWorld.r1cs powersOfTau28_hez_final_10.ptau HelloWorld/circuit_0000.zkey
...
snarkjs zkey export solidityverifier HelloWorld/circuit_final.zkey ../Multiplier3Verifier.sol
